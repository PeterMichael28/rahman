...
const Footer = () => {
  ...
  return (
    <>
      <footer className="relative bg-primary-light mt-24 min-h-[390px]">
        ...
        <div className="max-w-[1200px] w-full mx-auto px-5 lg:px-0 pt-10 lg:pt-20">
          ...
          <div className="flex flex-col lg:flex-row items-start lg:justify-between w-full max-lg:px-6 p-8 pt-10 lg:pt-10  mt-[58px]  relative max-lg:h-[340px]">
            ...
            <div className="flex flex-col justify-between items-stat w-full relative z-20 h-auto  lg:mt-6">
            ...
            <div className="flex justify-start lg:justify-end gap-x-[90px] items-start mt-7 lg:mt-5 relative z-20 w-full ">
      ...
      <div className="w-full h-[100px] lg:h-[86px] flex justify-center items-center flex-col lg:flex-row bg-[#F5F1FE] gap-x-1 gap-y-1">
